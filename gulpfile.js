// Generated on 2017-07-15 using generator-jhipster 4.6.1
'use strict';
...
gulp.task('copy:customize', copy.customize);
...
gulp.task('assets:prod', ['images', 'styles', 'html', 'copy:images', 'copy:customize'], build);
...
gulp.task('ngconstant:dev', function () {
    return ngConstant({
        ...
        constants: {
            ...
            BUILD_TIMESTAMP: '',
            KEY_GOOGLE_MAP_API: 'AIzaSyCn1McjKZGgwkBbK9Kh64f4NmhnPM7MeS8',
            API_CONFIG: {
                // URL_UPLOAD_GENERAL: 'http://128.199.166.206/uploads/general/',
                // URL_UPLOAD_HOTEL: 'http://128.199.166.206/uploads/hotel/',
...
gulp.task('build', ['clean'], function (cb) {
    runSequence(['copy', 'inject:vendor', 'ngconstant:dev', 'copy:languages'], 'inject:app', 'inject:troubleshoot', 'assets:prod', cb);
});
