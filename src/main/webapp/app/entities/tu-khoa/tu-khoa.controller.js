(function() {
    ...
    angular
        ...
        .controller('TuKhoaController', TuKhoaController);

    TuKhoaController.$inject = ['$state', '$scope', '$stateParams', '$localStorage', 'TuKhoa', 'AlertService'];

    function TuKhoaController($state, $scope, $stateParams, $localStorage, TuKhoa, AlertService) {
