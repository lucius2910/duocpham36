(function() {
    ...
    angular
        ...
        .controller('UncategoryController', UncategoryController);

    UncategoryController.$inject = ['$state', '$rootScope', '$scope', '$stateParams', '$localStorage', 'Uncategory', 'ParseLinks', 'AlertService', '$sce'];

    function UncategoryController($state, $rootScope, $scope, $stateParams, $localStorage, Uncategory, ParseLinks, AlertService, $sce) {
